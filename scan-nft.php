    ...
    <a-nft 
         markerhandler
            ...
            <a-entity
                    ...
                    <a-box geometry="primitive: box; width: 1.5; height: 0.5; depth: 5" material="opacity: 100" collider="shape: box"></a-box>
            </a-entity>
            <a-entity
                    ...
                    <a-box geometry="primitive: box; width: 1.55; height: 0.5; depth: 5" material="opacity: 100" collider="shape: box"></a-box>
            </a-entity>
            <a-entity
